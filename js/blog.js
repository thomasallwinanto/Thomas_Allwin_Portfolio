...
window.blogs = {
  ...
  blog5: {
    ...
    body: '<p>I recently rewatched True Detective S1. It follows two detectives Rust Cohle, played by Matthew McConaughey, and Marty Hart, played by Woody Harrelson. Right after I finished S1, I went on to watch the latest season. S4, named "True Detective Night Country", starring Jodie Foster as Detective Danvers and Kali Reis as Officer Navarro. S4 and S1 share many similarities. Two detectives who are polar opposites, who don’t get along, trying to find a killer in a place that feels like “a memory of a town, and the memory is fading” (I had to mention it here). When you watch S1 and try to relate to the protagonists, most people would probably connect more with Marty than the “Tax Man.” He has his flaws and he is vulnerable to the simple pleasures of life. At the same time, you wish you were Rust Cohle. Stoic, delivering nihilistic monologues, and being “edgy” (Hart’s words, not mine). The script is solid, the acting is amazing, the characters are complex, and the soundtracks are subtle yet intense. It might be one of the best shows I’ve ever watched. Now, coming to S4. Jodie Foster and Kali Reis take on similar “opposites” roles. Foster’s character has a strange psychological relation with the Beatles. The song "Twist and Shout" triggers memories of her late son, and the show brings it up multiple times through a melancholic version of the song. It comes across as unbearable, unnecessary, and cringe-worthy. She is also battles to manage her relationship with adopted daughter and her subordinate. Reis plays a demoted officer after a past case went south. She struggles with hallucinations, an identity crisis, relationship with her sister and her boyfriend. The case itself they are trying to solve is somehow interconnected with these personal struggles, societal problems, racism, environmental issues, propagandas and other such trending events. The connections feel forced and too woke. The season is full of loose ends, incomplete storylines, unanswered questions, and moments that just make you go, “Why?”. It also tries too hard to lure in fans of S1 by introducing Travis Cohle (Rust’s father), the spiral logo, callbacks like “time is a flat circle,” and other references to death and fate. Overall, I would rate this season the same number as its order. A Four. I really hope the next installment is better and avoids cheap tricks like bringing in legacy characters, recycled quotes, or even remotely try to relate it with the original season.</p>'
  }
};
